...
export default function Orderinfoadmin({ match }) {
    ...
    return (
        <div>
            ...
            {order && (
                <div>
                    <div className="row justify-content-center">
                        <div className="col-md-5 card text-left">
            ...
            <div style={{"textAlign":"right"}}>
                <button className="btn mt-2" style={{"textAlign":"center"}} onClick={()=>{window.location.href='/admin/orderslist'}}>Back</button>
            </div>
